  ...
  async healthCheck(req, res) {
    try {
      ...
      res.json({ 
        ...
        browserPool: stats,
        config: {
          maxRequestsPerMinute: require("../config/app").rateLimit.maxRequestsPerMinute,
          maxConcurrentBrowsers: require("../config/app").browser.maxConcurrentBrowsers,
          maxPagesPerBrowser: require("../config/app").browser.maxPagesPerBrowser
        }
      });
    } catch (err) {
